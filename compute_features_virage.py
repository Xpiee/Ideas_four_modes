...
main_folder = "X:/RealTimeSegment/Driving Simulator/Raw/ECG_EDA"
savePath = 'X:/RealTimeSegment/Driving Simulator/Extracted'
mk_dirs(savePath)
...
baseline_folder = "X:/RealTimeSegment/Driving Simulator/Raw/ECG_EDA_baseline"
baseline_save_folder = os.path.join('X:/RealTimeSegment/Driving Simulator/Extracted', 'ECG_EDA_baseline_Features')
